<?php
	...
	$barLen = 30;
	$barMargin = 0;
	$barMargin = ($xWidth - $barLen*4)/(4 - 1);	$image = imagecreatetruecolor($width, $height);
	...
	imagestring($image, 5, $xmargin + 20, 30, 'os', $black);
	...
	imagestring($image, 2, $xstart - 6 + $barMargin*0, $ystart + 20, 'Window', $black);
